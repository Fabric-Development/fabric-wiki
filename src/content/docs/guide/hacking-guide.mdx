...
<Aside type="tip">
  ...
  useful resources to learn more about GTK and GObject. - [Sebastian's tutorial
  on PyGObject](https://python-gtk-3-tutorial.readthedocs.io/en/latest/) - [The
  official tutorial from
  PyGObject](https://gnome.pages.gitlab.gnome.org/pygobject/) - [The docs the
  maintainer personally uses](https://lazka.github.io/pgi-docs/) - [Foundations
  of PyGTK Development
  (book)](https://link.springer.com/book/10.1007/978-1-4842-4179-0)
</Aside>
...
For more details on services, head over to [this wiki page](./services.mdx).
