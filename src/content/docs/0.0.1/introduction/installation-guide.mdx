...
sidebar:
  order: 3
slug: 0.0.1/introduction/installation-guide
---
...
<Aside type="tip">
  If you're on Arch Linux, Fabric is available in the AUR under the name `python-fabric-git`.
  If you use a different distribution and you would like to install Fabric globally, use the following command.
</Aside>
...
Congrats! Fabric is now installed, and you can run and use it as long as you would like. To get auto-completion and type annotation functionality in your text editor, head over to the [stubs installation guide](./installing-stubs.mdx).
