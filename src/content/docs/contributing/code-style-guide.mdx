...
x = "the unknown guy" if unexpected_feature is True else None
y = "idk" if unexpected_feature is True else None
z = 4002 if unexpected_feature is True else None
```
...
```
fix: Check for fraudulent koalas before allocating balloons
```
